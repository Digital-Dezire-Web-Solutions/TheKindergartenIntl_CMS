...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    aboutIntro: Schema.Attribute.Component<'shared.about-intro', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    discourse: Schema.Attribute.Component<'shared.discourse', false>;
    facilities: Schema.Attribute.Component<'shared.facilities-items', true>;
    facilitiesDescription: Schema.Attribute.Text;
    ...
    > &
      Schema.Attribute.Private;
    missionVision: Schema.Attribute.Component<'shared.mission-vision', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiAdmissionsPageAdmissionsPage
  ...
  attributes: {
    applicationStep: Schema.Attribute.Component<
      'shared.application-steps',
      true
    >;
    applicationSubtitle: Schema.Attribute.String;
    applicationTitle: Schema.Attribute.String;
    brochure: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    documentList: Schema.Attribute.Component<'shared.document-list', true>;
    documentsImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    documentsSubtitle: Schema.Attribute.String;
    documentsTitle: Schema.Attribute.String;
    eligibilityDescription: Schema.Attribute.Text;
...
export interface ApiContactLeadContactLead extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    childsAge: Schema.Attribute.String;
    childsName: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
...
export interface ApiContactPageContactPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    admissionTitle: Schema.Attribute.String;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    chooseSubTitle: Schema.Attribute.String;
    chooseTitle: Schema.Attribute.String;
    chooseusItems: Schema.Attribute.Component<'shared.facilities-items', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    educationalProgramsTitle: Schema.Attribute.String;
    facilitiesItems: Schema.Attribute.Component<
      'shared.facilities-items',
      true
    >;
    facilitiesSubtitle: Schema.Attribute.String;
    facilitiestitle: Schema.Attribute.String;
    founderDescription: Schema.Attribute.Blocks;
    founderImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    founderName: Schema.Attribute.String;
    founderSubtitle: Schema.Attribute.String;
    ...
    uceventTitle: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProgramsPageProgramsPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    programs: Schema.Attribute.Component<'shared.program-item', true>;
    publishedAt: Schema.Attribute.DateTime;
    subTitle: Schema.Attribute.String;
...
export interface ApiSocialMediaSocialMedia extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    socialMediaItems: Schema.Attribute.Component<
      'shared.social-media-items',
      true
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
